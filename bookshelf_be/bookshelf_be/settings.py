"""
Django settings for bookshelf_be project.
...
SECRET_KEY = 'django-insecure-!r^sqvz6!lgj2j_*d!dtt)^ce^3eg@5$+=!4hlae5i(cfo(fh%'
...
WSGI_APPLICATION = 'bookshelf_be.wsgi.application'
